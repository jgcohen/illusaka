...
class __TwigTemplate_126dd75eb781fe1721a2ecf5eb298641233e113a88b93d5f58b6fc3c7772b7d7 extends Template
{
    private $source;
    private $macros = [];
...
<a href=\"";
            // line 65
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin", ["id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 65, $this->source); })()), "user", [], "any", false, false, false, 65), "id", [], "any", false, false, false, 65)]), "html", null, true);
            echo "\">Admin page</a>
";
        }
    ...
    {
        return array (  172 => 65,  169 => 64,  167 => 63,  158 => 56,  152 => 43,  128 => 22,  122 => 18,  119 => 17,  113 => 14,  109 => 13,  106 => 12,  103 => 11,  97 => 9,  94 => 8,  92 => 7,  86 => 3,  36 => 1,);
    }
...
<a href=\"{{ path('admin',{id:app.user.id}) }}\">Admin page</a>
{% endif %}
{% endblock %}
", "security/login.html.twig", "C:\\MAMP\\aka\\aka\\templates\\security\\login.html.twig");
    }
}
